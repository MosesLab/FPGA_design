...
#! /usr/bin/perl 
    ...
    while( $option = shift @ARGV )
    {
        ...
        # -xst                 : Select XST as synthesis tool specifically
        if($option =~ /^-xst/)
        {
            $use_xst = 1;
            $use_synplify = 0;
    ...
    if($no_synthesis == 0)
    {
        ...
        if($use_xst == 1)
        {
            ...
            print SCR_FILE "-p xc5vlx30t-1ff665\n";
        ...
        if($use_synplify == 1)
        {
            ...
            print PRJ_FILE "set_option -part xc5vlx30t\n";
    ...
    if($no_ngdbuild == 0)
    {
        ...
        if($use_ngc == 1)
        {
            system ("ngdbuild -uc ../ucf/example_mgt_top.ucf -p xc5vlx30t-ff665-1 example_mgt_top.ngc example_mgt_top.ngd");
        }
        else
        {
            system ("ngdbuild -uc ../ucf/example_mgt_top.ucf -p xc5vlx30t-ff665-1 example_mgt_top.edf example_mgt_top.ngd");
        }
    }
    ...
    if($no_map == 0)
    {
        system("map -p xc5vlx30t-ff665-1 -timing -o example_mgt_top_unrouted.ncd example_mgt_top.ngd example_mgt_top.pcf");
    }
    ...
    if($no_par == 0)
    {
        system("par -w -t 1 example_mgt_top_unrouted.ncd example_mgt_top.ncd example_mgt_top.pcf");
    }
