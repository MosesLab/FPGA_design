...
puts "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
puts "MGT Wrapper"
vcom -93 -work work  "pciegtp_wrapper_tile.vhd";
vcom -93 -work work  "pciegtp_wrapper.vhd";

puts "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
puts "Example Design modules"
vcom -93 -work work  "../../dpa64x8_b16x32_mod.vhd";
vcom -93 -work work  "gtp_frame_tx.vhd";
vcom -93 -work work  "gtp_frame_rx.vhd";
vcom -93 -work work  "mgt_tester.vhd";
vcom -93 -work work  "example_tb.vhd";
